DROP DATABASE IF EXISTS main_cloud;
CREATE DATABASE IF NOT EXISTS main_cloud DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `database_info` VALUES (1149954992195629058, 'master', 'com.mysql.cj.jdbc.Driver', 'root', 'root', 'jdbc:mysql://127.0.0.1:3306/main_cloud?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT', '主数据源，项目启动数据源！', '2019-07-13 16:13:29');
COMMIT;
